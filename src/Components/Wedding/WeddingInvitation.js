...
const WeddingInvitation = ({ onButtonClick, isVisible }) => {
  ...
  const bottomOrnaments = [
    ...
    { src: orn29, size: "23rem", sizemd: "20rem", zIndex: 0, position: "-bottom-4 left-0", animation: isVisible ? "opacity-100 ping" : "opacity-0", style: { rotate: "0deg" } },
    { src: orn29, size: "23rem", sizemd: "20rem", zIndex: 0, position: "-bottom-4 left-[12rem]", animation: isVisible ? "opacity-100 ping" : "opacity-0", style: { rotate: "0deg" } },
    { src: orn29, size: "23rem", sizemd: "20rem", zIndex: 0, position: "-bottom-4", animation: isVisible ? "opacity-100 ping" : "opacity-0", style: { rotate: "0deg" } },
    { src: orn29, size: "23rem", sizemd: "20rem", zIndex: 0, position: "-bottom-4 right-[12rem]", animation: isVisible ? "opacity-100 ping" : "opacity-0", style: { rotate: "0deg" } },
    { src: orn29, size: "23rem", sizemd: "20rem", zIndex: 0, position: "-bottom-4 right-0", animation: isVisible ? "opacity-100 ping" : "opacity-0", style: { rotate: "0deg" } },
